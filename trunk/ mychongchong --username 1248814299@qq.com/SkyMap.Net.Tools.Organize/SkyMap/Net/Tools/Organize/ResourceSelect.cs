namespace SkyMap.Net.Tools.Organize
{
    ...
    public class ResourceSelect : Form
    {
        ...
        {
            string sql = "select " + this.authType.ResourceIdField + "," + this.authType.ResourceNameField + " from " + this.authType.ResourceTable;
            this.grid.DataSource = QueryHelper.ExecuteSql(typeof(CAuthType).Namespace, string.Empty, sql);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.view.Appearance.EvenRow.Font = new Font("宋体", 9f, FontStyle.Regular, GraphicsUnit.Point, 0x86);
            ...
            this.view.Appearance.OddRow.Font = new Font("宋体", 9f, FontStyle.Regular, GraphicsUnit.Point, 0x86);
