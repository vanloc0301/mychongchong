...
(def-method (str-delim (x System.Collections.IEnumerable.) &key (start true))
	(if start 
		(+ "{" (str (type-of x)) " ")
		"}"))

(def-method (str-delim (x System.Collections.IEnumerator.) &key (start true))
	(if start 
		(+ "{" (str (type-of x)) " ")
		"}"))
...
(def (__strseq seq)
	(let (	s (StringBuilder. (str-delim seq))
		...
		(let (c 0 e (get-enum seq))
			(while (and (< c limit) (.System.Collections.IEnumerator:MoveNext e))
				(s.Append (str (.System.Collections.IEnumerator:Current e)))
				(s.Append " ")
				(++ c)
...
(def-method (str (obj ICollection.))
	(let (	s (StringBuilder.) 
		...
		(for (c 0 e (.System.Collections.IEnumerable:GetEnumerator obj)) 
...
(def-macro (for-each var coll &rest body)
	(let (enum (gensym))
		`(let (~enum (get-enum ~coll))
			(while (.System.Collections.IEnumerator:MoveNext ~enum)
				(let (~var (.System.Collections.IEnumerator:Current ~enum))
					~@body)))))
...
(def (map1 key seq)
	(make-enum
		(e (get-enum seq))
		(key (.System.Collections.IEnumerator:Current e))
		(.System.Collections.IEnumerator:MoveNext e)))

(def (filter pred seq)
	(make-enum
		(e (get-enum seq))
		(.System.Collections.IEnumerator:Current e)
		(let (seeking true)
			(while (and seeking (.System.Collections.IEnumerator:MoveNext e))
				(when (pred (.System.Collections.IEnumerator:Current e))
					(set seeking false)))
			(not seeking))))
...
(def (concat &rest seqs)
	(make-enum
		(next-e (fn () (get-enum (if (nil? seqs)
		 ...
		 e  (next-e))
		(.System.Collections.IEnumerator:Current e)
		(if (.System.Collections.IEnumerator:MoveNext e)
			true
			(block 
				(while (and (next! seqs) 
							(set e (next-e)) 
							(not (.System.Collections.IEnumerator:MoveNext e))))
					;no body
				(not (nil? seqs))))))
...
(def (reduce f seq &key init)
	(lets (	e (get-enum seq)
			has-items (.System.Collections.IEnumerator:MoveNext e)
			result (cond 
						(not has-items) (if (missing? init) (f) init)
						(missing? init) (.System.Collections.IEnumerator:Current e)
						:else (f init (.System.Collections.IEnumerator:Current e))))
		(when has-items
			(while (.System.Collections.IEnumerator:MoveNext e)
				(set result (f result (.System.Collections.IEnumerator:Current e)))))
		result))
...
(def (map f &rest seqs)
	(if (== 1 (len seqs))
		...
		(make-enum
			...
			(apply f (map1 .System.Collections.IEnumerator:Current es))
			(let (ret true)
				(for-each e es
					(when-not (.System.Collections.IEnumerator:MoveNext e)
						(set ret false)))
				ret))))
