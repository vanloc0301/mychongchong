namespace SkyMap.Net.Core
{
    ...
    public class Properties
    {
        ...
        public event SkyMap.Net.Core.PropertyChangedEventHandler PropertyChanged;
        ...
        public void CopyTo(Properties target)
        {
            ...
            {
                target.Set<object>(pair.Key, pair.Value);
            }
        }
        ...
        public T Get<T>(string property, T defaultValue)
        {
            ...
            if (((obj2 is string) && (typeof(T) != typeof(object))) && (typeof(T) != typeof(string)))
            {
        ...
        protected virtual void OnPropertyChanged(SkyMap.Net.Core.PropertyChangedEventArgs e)
        {
        ...
        public void Set<T>(string property, T value)
        {
            ...
            this.OnPropertyChanged(new SkyMap.Net.Core.PropertyChangedEventArgs(this, property, oldValue, value));
        }
        ...
        private void WriteValue(XmlTextWriter writer, object val)
        {
            if (val != null)
            {
                if (val is string)
