namespace SkyMap.Net.Workflow.FlowChart
{
    ...
    public class fSelectTempletAppendixs : Form
    {
        ...
        public fSelectTempletAppendixs()
        {
        ...
        private void fSelectTempletAppendixs_Load(object sender, EventArgs e)
        {
            this.InitColumns();
            this.RefreshList();
            if (this.mID != null)
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager manager = new ComponentResourceManager(typeof(fSelectTempletAppendixs));
            ...
            base.Name = "fSelectTempletAppendixs";
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "请选择";
            base.Load += new EventHandler(this.fSelectTempletAppendixs_Load);
        ...
        public void RefreshList()
        {
            ...
            IList<WfTempletAppendixs> list = QueryHelper.List<WfTempletAppendixs>("ALL_WfTempletAppendixs_DAO");
            foreach (WfTempletAppendixs appendixs in list)
            {
                current = new ListViewItem(appendixs.Id);
                current.SubItems.Add(appendixs.Name);
                current.SubItems.Add(appendixs.Description);
                current.Tag = appendixs.Id;
