namespace SkyMap.Net.Workflow.FlowChartCtl
{
    ...
    public class fSelectSubflow : Form
    {
        ...
        private void fSelectSubflow_Load(object sender, EventArgs e)
        {
            this.InitColumns();
            this.RefreshList();
            if (this.mID != null)
        ...
        private void InitializeComponent()
        {
            ...
            ResourceManager manager = new ResourceManager(typeof(fSelectSubflow));
            ...
            base.Name = "fSelectSubflow";
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "请选择";
            base.Load += new EventHandler(this.fSelectSubflow_Load);
        ...
        public void RefreshList()
        {
            ...
            IList<Prodef> list = QueryHelper.List<Prodef>("ALL_Prodef_DAO");
            foreach (Prodef prodef in list)
            {
                current = new ListViewItem(prodef.Id);
                current.SubItems.Add(prodef.Name);
                current.SubItems.Add(prodef.Description);
                current.Tag = prodef.Id;
