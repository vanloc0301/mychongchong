...
namespace SpeedTest
{
    ...
    class Performance
    {
        ...
        private static void FactTest()
        {
            ...
            string directory = @"C:\Documents and Settings\Administrator\×ÀÃæ\SimpleRuleEngine\RuleEngine\SpeedTest\ChainedRules.xml";//AppDomain.CurrentDomain.BaseDirectory + @"\..\..\ChainedRules.xml";
