...
namespace Gujia.Method
{
   ...
   ///功能描述    :    
   ///开发者      :    
   ///建立时间    :    2010-2-1 16:30:28
   ///修订描述    :    
   ///进度描述    :    
   ///版本号      :    1.0
   ///最后修改时间:    2010-2-1 16:30:28
   ///
   ///Function Description :    
   ///Developer                :    
   ///Builded Date:    2010-2-1 16:30:28
   ///Revision Description :    
   ///Progress Description :    
   ///Version Number        :    1.0
   ///Last Modify Date     :    2010-2-1 16:30:28
   /// </summary>
   public class 住宅修正因素
   {
      #region 构造函数
      ...
      public IList 住宅区片
      {
         get {  return m_住宅区片_土地级别; }
         set {  m_住宅区片_土地级别 = value; }
      }
