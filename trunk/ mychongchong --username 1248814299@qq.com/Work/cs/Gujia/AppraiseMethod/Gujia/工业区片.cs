...
namespace Gujia.Method
{
   ...
   public class 工业区片
   {
      ...
      public 工业区片(string 镇区编号,string 镇区名称,double 区片号,double 区片价,工业修正因素 工业修正因素,double 级别价,string 四至,string 道路交通状况,string 基础设施状况,string 产业聚集程度,string 环境质量状况,string 地质状况,string 其他)
      {
         this.m_镇区编号=镇区编号;
         this.m_镇区名称=镇区名称;
         this.m_区片号=区片号;
         this.m_区片价=区片价;
         this.m_工业修正因素=工业修正因素;
         this.m_级别价=级别价;
         this.m_四至=四至;
         this.m_道路交通状况=道路交通状况;
         this.m_基础设施状况=基础设施状况;
         this.m_产业聚集程度=产业聚集程度;
      ...
      public IList 工业修正系数
      {
         get {  return m_工业修正系数_区片号; }
         set {  m_工业修正系数_区片号 = value; }
      }
