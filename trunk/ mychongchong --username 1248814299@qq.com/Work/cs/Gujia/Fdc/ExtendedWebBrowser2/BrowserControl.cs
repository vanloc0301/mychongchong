  ...
  partial class BrowserControl : UserControl
  {
    ...
    void _browser_StartNewWindow(object sender, BrowserExtendedNavigatingEventArgs e)
    {
      ...
      // to the WindowManager.
        GujiaDataForm mf = GetMainFormFromControl(sender as Control);
      if (mf == null)
        return;
    ...
    private static GujiaDataForm GetMainFormFromControl(Control control)
    {
      while (control != null)
      {
          if (control is GujiaDataForm)
          break;
        control = control.Parent;
      }
      return control as GujiaDataForm;
    }
