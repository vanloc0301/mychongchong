...
namespace ZBPM
{
  ...
  class SettingsHelper
  {
    ...
    {
      get { 
          return ( PopupBlockerFilterLevel)Enum.Parse( typeof(PopupBlockerFilterLevel), _mySettings.FilterLevel); 
      }
      set { 
          _mySettings.FilterLevel = Enum.GetName(typeof( PopupBlockerFilterLevel),value); 
      }
    }
