...
namespace RuleEngine.Evidence
{
    ...
    public class ExpressionEvaluator
    {
        ...
        private static readonly string LogicalRegEx = @"(\x29|\x28|>=|<=|!=|==|<|>|AND|OR|NOT|ISNULL|XOR|\x2b|\x2d|\x2a|\x2f|\x5e)";
        ...
        private Symbol EvaluatePow(Symbol op1, Symbol op2)
        {
            Symbol op3 = new Symbol();
            op3.type = Type.Value;
            object o1 = null;
            ...
            try
            {
                ...
                if (o1 is string || o2 is string)
                    ...
                    //replacement = (double)o1 + (double)o2;
                    replacement = Math.Pow((double)o1, (double)o2);
                else
                    throw new Exception("only to be caught");
            }
            catch
