namespace SkyMap.Net.Gui.XmlForms
{
    ...
    public class XmlLoader
    {
        ...
        private Dictionary<object, string> tooltips = new Dictionary<object, string>();
        ...
        public object CreateObjectFromFileDefinition(string fileName)
        {
            ...
            this.customizationObject = this.objectCreator.CreateObject(XmlConvert.DecodeName(documentElement.Name), documentElement);
        ...
        public void LoadObjectFromXmlDefinition(string xmlContent)
        {
            ...
            this.SetUpObject(this.customizationObject, document.DocumentElement);
        }
        ...
        public void LoadObjectFromXmlDocument(object customizationObject, XmlDocument doc)
        {
            ...
            if (this.tooltips.Count > 0)
            {
                ...
                foreach (KeyValuePair<object, string> pair in this.tooltips)
                {
                    tip.SetToolTip((Control) pair.Key, pair.Value);
                }
            }
        }
        ...
        private void SetAttributes(object o, XmlElement el)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (obj2 is IList)
                    {
                        foreach (XmlNode node in el.ChildNodes)
                        {
                            if (node is XmlElement)
                            {
                                ...
                                object currentObject = this.objectCreator.CreateObject(XmlConvert.DecodeName(element.Name), element);
                    ...
                    {
                        object obj4 = this.objectCreator.CreateObject(o.GetType().GetProperty(el.Name).PropertyType.Name, el);
                        if (obj4 is IComponent)
                        {
                            ...
                            obj4 = this.objectCreator.CreateObject(name, el);
                        }
        ...
        private void SetValue(object o, string propertyName, string val)
        {
            try
            {
                ...
                {
                    obj2 = this.objectCreator.GetType(property.PropertyType.FullName).Assembly.CreateInstance(property.PropertyType.FullName);
                }
                else
                {
