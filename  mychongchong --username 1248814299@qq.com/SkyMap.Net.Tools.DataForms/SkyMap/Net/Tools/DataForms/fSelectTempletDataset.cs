namespace SkyMap.Net.Tools.DataForms
{
    ...
    public class fSelectTempletDataset : Form
    {
        ...
        private void fSelectTempletDataset_Load(object sender, EventArgs e)
        {
            this.InitColumns();
            this.RefreshList();
            if (this.mID != null)
        ...
        private void InitializeComponent()
        {
            ...
            ResourceManager manager = new ResourceManager(typeof(fSelectTempletDataset));
            ...
            base.Name = "fSelectTempletDataset";
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "请选择";
            base.Load += new EventHandler(this.fSelectTempletDataset_Load);
        ...
        public void RefreshList()
        {
            ...
            IList<DAODataSet> list = QueryHelper.List<DAODataSet>("ALL_DAODataSet_DAO");
            foreach (DAODataSet set in list)
            {
                current = new ListViewItem(set.Id);
                current.SubItems.Add(set.Name);
                current.SubItems.Add(set.Description);
                current.Tag = set.Id;
        ...
        public string TempletDatasetName
        {
            get
            {
                return this.mName;
